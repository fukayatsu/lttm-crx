...
View = (function() {
  function View(context) {
    this.context = context;
    // HACK: Set invalid value to popover to prevent parent popover from hiding
    this.$el = $("<div class='atwho-view' popover=\"invalid\"><ul class='atwho-view-ul'></ul></div>");
